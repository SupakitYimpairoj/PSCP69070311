...
| OJ submission ID, if submitted | 553910 |
| OJ status | Pass |
...
```text
ถามว่าจะหาสูตรคำนวณเปอร์เซ็นได้ไงเพราะ python คูณเปอร์เซ็นตรงๆไม่ได้
```
...
```text
ช่วยให้ผมได้สูตรมาคำนวณอย่างถูกวิธี
...
```text
ผมได้สูตรมาแล้วผมก็ไปแก้เพิ่ม if-else statement เพิ่ม เพราะตอนแรกผมไม่ได้เขียน
```
...
```text
เรียนรู้การหาผลรวมเปอร์เซ็น ความต่าง ใน python แต่ผมก็นึกออกว่าที่จริงถ้าค่าเปอร์เซ็นมันไม่เปลี่ยนอย่างงงี้เราใช้การคูณทศนิยมเพื่อหาผลต่างก็ได้ แต่ผมก็ไม่ได้เปลี่ยนมาใช้
```
