...
```text
input : แม่สีที่ให้เลือกมาสองสี output: ผลลัพธ์ของการผสมทั้งสองสี หากมีการใช้สีที่ไม่ใช่แม่สีให้พิม Error
```
...
```text
Step 1 : อ่านค่าสีทั้งสอง
Step 2 : ถ้าค่าสีเป็นแม่สีไปต่อ ถ้าไม่ใช่ print Error
Step 3: ใช้ if เผื่อดูว่าสีทั้งสองที่เลือกมาลงในกรณีไหน
Step 4 : print ผลลัพธ์ออกมา
```
...
```text
ผมใช้ if statement ตามที่วางแผนไว้ แต่ผมก็ได้เพิ่ม ในกรณีที่สีเหมือนกันแต่สลับหน้าหลังกับพิมพ์เล็กพิมพ์ใหญ่ด้วยเผื่อเพิ่มโอกาสผ่านทุกเทสเคส
```
...
```text
เพื่อดูว่าในกรณีที่ user ใส่เหมือนเดิมแต่แค่สลับก่อนหลังโปรแกรมยังทำได้ตามต้องการ
```
...
```text
เพื่อตรวจสอบว่าเมื่อมีการไม่ใส่แม่สีผลลัพธ์ออกมาเป็นตามต้องการไหม
```
