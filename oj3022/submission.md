...
```text
ให้รับค่าอุณหภูมิ หน่วยของอุณหภูมิ หน่วยของอุณหภูมิที่อยากแปลง แล้วนำมาแปลงตามสูตร

Input:
ตัวเลขอุณหภูมิ
อักษร C, F, K, R แสดงถึงหน่วยของอุณหภูมิที่รับมา
อักษร C, F, K, R แสดงถึงหน่วยของอุณหภูมิที่ต้องการแปลงไปเป็น

Output:
ตัวเลขอุณหภูมิที่แปลงมาจากหน่วยเริมเป็นหน่วยที่ต้องการแล้ว

Constraints:
ต้องตอบเป็นทศนิยมสองตำแหน่ง เลยต้องกำหนดไว้
```
...
```text
แผนแรกของการแปลงทุกกรณีเช่น ค่า c แปลงเป็น k ใช้สูตร c แปลงเป็น f ใช้สูตร.... ค่า R แปลงเป็น c ใช้สูตรแบบ 4 สูตรในของทุกหน่วย
```
...
```text
วิธีแรกผมมันไม่ค่อยเวิร์คเพราะติดเทสเคส และ ไม่ผ่าน prep8 เพราะ too many branches ผมเลยใช้ AI ด้วยการใช้ COURSE_AI_INSTRUCTIONS.md ช่วยดีบักและช่วยคิดวิธีที่จะย่อมันลงมาเพราะผมก็พอรู้ว่าบางกรณีมันอยู่ด้วยกันได้ ซึ่งวิธีที่ ai ช่วยผมคิดออกมาคือ แปลงทุกอย่างให้เป็น c ก่อนแล้วถ้า user สั่งให้เปลี่ยนเป็นอะไรค่อยแปลงจาก c ที่แปลงมาให้เป็นหน่วยที่ต้องการ ซึ่งผมคิดไม่ถึง555
```
...
```text
เพื่อทดสอลว่าค่า c ไป k ถูกต้องไหม
```
...
```text
เพื่อทดสอลว่าค่า r ไป c ถูกต้องไหม และเอาพุตเป็น - ได้แบบไม่มีปัญหา
```
...
```text
เพื่อทดสอลว่าค่า f ไป k ถูกต้องไหม
```
