...
| OJ submission ID, if submitted | 562114 |
| OJ status | Pass |
...
```text
ช่วยคิดสูตรคำนวนในรอบแรกที่ทำตามแบบที่ผมคิดคือใช้ if-else หลายกรณีแล้วสูตรก็ต้องเปลี่ยนไปเรื่อยๆ แล้วพอผมไม่ผ่านผมเลยให้ช่วยดีบักและช่วยคิดวิธีที่จะย่อมันลงมาเพราะผมไม่ผ่าน prep8 ผมก็พอรู้ว่าน่าจะมีบางกรณีมันอยู่ด้วยกันได้แต่ตอนนั้นนึกไม่ออกว่าต้องทำยังไง ซึ่งวิธีที่ ai ช่วยผมคิดออกมาคือ แปลงทุกอย่างให้เป็น c ก่อนแล้วถ้า user สั่งให้เปลี่ยนเป็นอะไรค่อยแปลงจาก c ที่แปลงมาให้เป็นหน่วยที่ต้องการ
```
...
```text
ช่วยให้ผมรู้ว่าบางสูตรในโค้ดของผมมันผิดเเละเป็นบัคเลยทำให้ไม่ผ่านเทสเคส และช่วยให้รู้ว่ามันมีวิธีที่ดีกว่าผมเขียนเยอะเพราะไม่ต้องสร้าง if else ทุกกรณีที่ต้องการจะะเปลี่ยน
```
...
```text
พอ ai ไกด์วิธีคร่าวๆ ผมก็เขียนโค้ดผมใหม่โดยแถบจะเขียนใหม่หมดโดยใช้หลักการที่ ai แน่นำคือแปลงเป็น c ก่อนแล้วค่อยแปลงหน่วยที่ต้องการอีกที
```
...
```text
ผมได้เรียนรู้ว่าการทำรอบแรกของผมที่ใช้ if else ทุกกรณีเป็นวิธีไม่ค่อยดีสักเท่าไหร่ เพราะมันมีจุดอาจจะทำให้เกิดบัคเยอะเนื่องจากสูตรที่ต้องเปลี่ยนไปตามกรณี
```
