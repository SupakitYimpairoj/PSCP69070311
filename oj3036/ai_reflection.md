...
| OJ submission ID, if submitted | 597752 |
| OJ status | Pass |
...
```text
ช่วยให้ผมสั่งเกต pattern ของข้อนี้ว่าจริงๆแล้วมันมี pattern คือเลขสุดท้ายของทุกแถว คือเลขยกกำลัง 2 ไปเรื่อยๆ
```
...
```text
กลับไปเพิ่มสูตรที่ได้รับมาจาก ai ที่ตอนแรกตัวผมนึกไม่ออก และได้คิดสูตรหาตำแหน่งในชั้นต่อ
```
...
```text
AI ช่วยให้ผมเห็นว่าถ้าจริงๆเราหาแพทเทิร์นได้มันก็อาจจะทำให้คิดสูตรการคำนวนออกเองได้
```
