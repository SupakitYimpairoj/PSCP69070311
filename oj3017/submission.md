...
```text
โจทย์ให้หาผลรวมของค่าอาหาร ค่าบริการ และ vat โดยที่ค่าบริการขั้นต่ำคือ 50 และจะเก็บไม่เกิน
100
input:
จำนวนเงินรวมเฉพาะค่าอาหารและเครื่องดื่มที่ลูกค้าได้สั่งไป
output:
...
```text
step 1: รับอินพุตค่าอาหาร
step 2: นำค่าอาหารมาหาผลรวม service charge ด้วยการคูณ 10% ลงไปตรงๆ
step 3: เช็คดูว่าค่าอาหารรวม service charge ส่วนต่างน้อยกว่า 50 ไหมถ้าใช่ นำ ค่าอาหาร + 50 * vat 
step 4: เช็คดูว่าค่าอาหารรวม service charge ส่วนต่างมากกว่า 1000 ไหมถ้าใช่ นำ ค่าอาหาร + 1000 * vat 
step 5: กรณีอื่น ค่าอาหารรวม service charge * vat
ก่อนถาม ai ผมไม่มั่นใจว่าจะหาเปอร์เซ็นยังไง ผมเลยถาม ai และใช้สูตรที่เค้าแนะนำ
```
...
```text
step 1: รับอินพุตค่าอาหาร
step 2: นำค่าอาหารมาหาผลรวม service charge (ai แนะนำมาว่า 1 + จำนวนเปอร์เซ็น * 100 แล้วถ้าจะหาผลต่างค่อยนำไปลบ)
step 3: เช็คดูว่าค่าอาหารรวม service charge ส่วนต่างน้อยกว่า 50 ไหมถ้าใช่ นำ ค่าอาหาร + 50 * vat 
step 4: เช็คดูว่าค่าอาหารรวม service charge ส่วนต่างมากกว่า 1000 ไหมถ้าใช่ นำ ค่าอาหาร + 1000 * vat 
step 5: กรณีอื่น ค่าอาหารรวม service charge * vat
```
...
```text
เพื่อเทสว่าในกรณีค่าอาหารรวมกับ service charge > 50 
```
...
```text
เพื่อเทสว่าในกรณีค่าอาหารรวมกับ service charge <50 และ <1000
```
...
```text
เพื่อเทสว่าในกรณีค่าอาหารรวมกับ service charge >1000
```
