...
| OJ submission ID, if submitted | 554103 |
| OJ status | Pass |
...
```text
ผมให้เอไอช่วยดีบักเพราะตอนแรกผมไม่ผ่านเทสเคส ผมเลยรู้ว่าเป็นดพราะผมไปก็อปโค้ดจากบรรทัดข้างบนมาแล้วลืมเปลี่ยนค่าใหม่
```
...
```text
bug ที่ตอนแรกผมไม่ทราบว่าเกิดจากอะไร
```
...
```text
ผมได้ตรวจสอบและกลับไปแก้กรณี if เดือนที่มันไม่ตรงกับอินพุทที่ผมอยากจะเช็คจริงๆ
```
...
```text
ผมได้เรียนรู้ว่าควรทำอะไรให้รอคอบกว่านี้
```
