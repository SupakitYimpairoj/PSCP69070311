...
```text
โจทย์นี้ให้ผมทำโปรแกรมอ่านค่า วันและและเดือน แล้วบอกฤดูออกมาเป็น output แต่ว่าถ้าเป็นวันที่21 เป็นต้นไปของเดือนที่3หารลงตัวคือ 3, 6, 9, 12 ให้เปลี่ยนเป็นฤดูถัดไป
...
Constraints:
น่าจะต้องแยกกรณีที่เดือนหาร 3 ลงตัวได้แต่วันที่มากหว่า 21 กับน้อยกว่า
```
...
```text
Step 1: รับค่า เดือนและวัน
Step 2: ตรวจสอบว่า ถ้าเดือน 1, 2, 3 และในเดือน 3 วันน้อยกว่า 21 
Step 3: ถ้าจริง ให้พิมพ์ "winter"
Step 4: ถ้าไม่จริง ให้ไปดูกรณีอื่นของเดือน 
Step 5: ถ้าจริงให้พิมพ์ฤดูตามเดือนออกมาเหมือนสเต็ปก่อนหน้า
Step 6: แล้วถ้าเป็นเดือนที่หารสามลงตัวแล้ววันมากกว่า 21
Step 7: ให้พิมพ์ฤดูถัดไปจากเดือนนั้น
```
...
```text
วิธีสุดท้ายผมของผมเหมือนแผนแรก แต่มีการเพิ่มการกำหนดค่าฤดูก่อนเข้า if เพราะตอนแรกไม่ได้กำหนดแล้วทำให้เกิด Unboundlocalerror
```
...
```text
ตรวจว่าฟังก์ชัน if ทำงานถูกต้องไหม
```
...
```text
ตรวจว่าฟังก์ชัน if ทำงานถูกต้องไหมถ้าเดือนในเดือนอื่น
```
...
```text
ตรวจว่าถ้าเป็นในเดือนหารสามลงตัวแล้วตั้งแต่วันที่ 21 ขึ้นไปจะได้ผมตามต้องการไหม
```
