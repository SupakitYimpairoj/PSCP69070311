...
| OJ submission ID, if submitted | 594486 |
| OJ status | Pass |
...
```text
ฉันให้ ai ช่วยในการคิดสูตรการคำนวน และ ได้วิธีการเก็บข้อมูลที่คำนวนแล้วด้วย append และดึงออกมาใช้ทีหลัง
```
...
```text
ได้วิธีการเก็บข้อมูลที่คำนวนแล้วด้วย append และดึงออกมาใช้ทีหลัง
```
...
```text
ผมแก้โค้ดด้วยการเพิ่มสูตรคำนวนเข้าไปโดยที่ตอนแรกผมนึกไม่ออก
```
