...
```text
ระบบให้คะแนนได้ 1-10 เมื่อโหวตแล้วระบบจะแสดงคะแนนรวม ถ้าคนที่ให้คะแนนสูงสุด และคะแนนต่ำสุดห่างกันเกินสองคะแนน พิม not surprise ถ้าห่างกันมากกว่านั้นพิม surprise

Input:
คะแนนของทั้งสามคน
คะแนนสูงสุดในจากสามคนนี้ 

Output:
surprising หรือ not surprising

Constraints:
ต้องใช้ float เพราะเลขจำนวนจริงอาจเป็นทศนิยม
```
...
```text
Step 1: รับค่ามารวมสามคน
Step 2: รับค่าคะแนนสูงสุดจากทั้งสามคน
Step 3: หาผลรวมด้วยการนำค่ารวมมาลบกับค่าสูงสุดคูณสอง
Step 4: ถ้าค่าคะแนนสูงสุดลบด้วยผลรวมแล้วตำกว่าหรือเท่ากับสองพิมพ์ Not surprising
Step 5: กรณีอื่นพิมพ์ surprising
```
...
```text
เพื่อทดสอบว่าโปรแกรมได้ผมจริงไหม
```
...
```text
เพื่อทดสอบว่าโปรแกรมได้ผมจริงไหมในอีกกรณี
```
...
```text
เพื่อทดสอบว่าโปรแกรมได้ผมจริงไหมในกรณีที่ผลรวมทที่คำนวนออกมาจากโปรแกรมเป็นติดลบ
```
