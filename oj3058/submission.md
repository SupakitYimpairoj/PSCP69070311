...
```text
โจทย์สร้างสะพานตามความยาวที่กำหนด ให้นำก้อนใหญ่ใช้ให้หมดก่อนใช้ก้อนเล็กแล้วหาว่าต้องใช้ก้อนเล็กกี่ก้อน ถ้าสร้างไม่พอให้ตอบ -1
...
Output:
จำนวนอิฐก้อนเล็กที่ต้องใช้ ถ้าไม่สามารถสร้างได้ ตอบ -1

Constraints:
ต้องสร้างกรณีที่อิฐหมดแล้วแต่ว่าสร้างไม่พอให้เอาพุตออกมาเป็น -1
```
...
```text
Step 1: อ่านจำนวนเต็ม a
Step 2: อ่านจำนวนเต็ม b
Step 3: อ่านจำนวนเต็ม goal
Step 4: กำหนดค่าความยาวของ a กับ b ตามโจทย์
Step 5: จากนั้นถ้า b มากกว่า 0 และ goal >= ความยาว b ให้ลบ goal ด้วยความยาวของก้อนอิฐ แล้วก็ลบอิฐ b ที่มีให้ไป 1
Step 6: จากนั้นถ้า a มากกว่า 0 และ goal >= ความยาว a ให้ลบ goal ด้วยความยาวของก้อนอิฐ แล้วก็ลบอิฐ a ที่มีให้ไป 1 แล้วบวกเข้าไปในผลรวม แล้ววนเรื่อยๆจนเสร็จ
step 7: ถ้าในกรณีอื่นก็คือสร้างไม่พอให้ผลรวม = -1
...
```text
เพื่อดูว่าโปรแกรมใช้ได้ตามที่คิดไหม
```
...
```text
เพื่อดูว่าในกรณีที่ไม่พอโปรแกรมเอาพุตออกมาถูกต้องไหม
```
...
```text
เพื่อดูว่าในกรณีที่เป็นเลขเยอะๆจะไม่เกิด error เพราะใช้เวลานานเกิน
```
